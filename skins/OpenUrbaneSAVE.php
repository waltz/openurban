		...
		<div class="header container_16">
			...
			<div class="grid_8">
                            <div class="portlet logo" id="p-logo">
                                    <a style="background-image: url(<?php  echo $wgScriptPath."/images/openurban_text_logo_beta.png" ?>);" <?php
			...
			<div class="grid_8">
				<div class="headerRight">
					<div class=login>
                    <a href="http://openurban.net/mediawiki/index.php?title=Special:UserLogin&returnto=Home">Login/Create Account</a>			
                    </div>
                    <div class="search">
						<?php
...
<div class="wideMainmenu">
	<div class="container_16">
		<div id="p-navigation">
        	<ul>
            	<li>
                	<a href="/mediawiki/index.php?title=Map"><?php echo translate('Map','Harita'); ?></a> 
                </li>
                <li>
                    <a href="http://openurban.net/mediawiki/index.php?title=Special:BrowseData/Project">CITY INDEX</a> 
                </li>
                <li>  
                    <a href="/mediawiki/index.php?title=Add_Project">Add Project</a>
                </li>
                <li>  
                    <a href="http://openurban.net/mediawiki/index.php?title=Feedback">FEEDBACK</a>
                </li>
            </ul>
        </div>
    </div>
	...
	<div class="container_16">
		...
		<div id="footer"<?php $this->html('userlangattributes') ?> class="grid_16">
			...
			<div class="grid_4 alpha">
				<div class="footerToplist">CONNECT</div>
				<div class="pBody">
					<ul>
						<li><a href="http://www.facebook.com/OpenUrban">Facebook</a></li>
						<li><a href="http://www.twitter.com/Open_Urban/">Twitter</a></li>
						<li><a href="http://eepurl.com/nrhGD">Newsletter</a></li>
					</ul>
				</div>
			</div>
			<div class="grid_4">
				<div class="footerToplist">ABOUT</div>
				<div class="pBody">
					<ul>
						<li><a href="http://openurban.net/mediawiki/index.php?title=Team">Team</a></li>
						<li><a href="http://openurban.net/mediawiki/index.php?title=History">History</a></li>
						<li><a href="mailto:info@openurban.net">Contact</a></li>
					</ul>
				</div>
			</div>
			<div class="grid_4">
				<div class="footerToplist">HELP</div>
				<div class="pBody">
					<ul>
						<li><a href="http://openurban.net/mediawiki/index.php?title=Guidelines">Guidelines</a></li>
						<li><a href="http://openurban.net/mediawiki/index.php?title=How_To">How To</a></li>
						<li><a href="http://openurban.net/mediawiki/index.php?title=FAQ">FAQ</a></li>
					</ul>
				</div>
			</div>
			<!--<div class="grid_4">-->
