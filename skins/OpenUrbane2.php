 ...
 * @ingroup Skins
 */
class Skinopenurbane2 extends SkinTemplate {
	/** Using gmwfreeblue. */
	var $skinname = 'openurbane2', $stylename = 'openurbane2',
		$template = 'openurbane2Template', $useHeadElement = true;
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		$out->addStyle( 'openurbane2/960.css', 'screen' );  
		$out->addStyle( 'openurbane2/gmw.css', 'screen' );
	}
}
 ...
 * @ingroup Skins
 */
class openurbane2Template extends QuickTemplate {
	var $skin;
	/**
		...
		<div class="header container_16">
			...
			<div class="grid_8">
                            <div class="portlet logo" id="p-logo">
                                    <a style="background-image: url(<?php  echo $wgScriptPath."/images/openurban_text_logo.png" ?>);" <?php
...
<hr color="#333333" size="1" width="100%">
	<div class="container_16">
