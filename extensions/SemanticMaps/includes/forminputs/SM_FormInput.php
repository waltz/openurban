...
class SMFormInput {
	 ...
	 * @return string
	 */
	public function getEditorInputOutput( $cur_value, $input_name, $is_mandatory, $is_disabled, array $params ) {
		global $wgOut;
		$parameters = array();
		...
		$html = "
			<div >
				<textarea id='map-polygon' name='" . htmlspecialchars( $input_name ) . "' cols='4' rows='2'>$cur_value</textarea>
			</div>";
